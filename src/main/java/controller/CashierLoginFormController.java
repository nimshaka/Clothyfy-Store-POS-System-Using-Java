...
public class CashierLoginFormController {
    ...
    public void btnCashierLoginOnAction(ActionEvent actionEvent) {
        try {
            String SQL= "SELECT * FROM Employee WHERE emailAddress =? and employeeID = ?";
            ...
            if (txtUserName.getText().isEmpty() || txtPassword.getText().isEmpty()){
                ...
                if(resultSet.next()){
                    ...
                    try {
                        stage.setScene(new Scene(FXMLLoader.load(getClass().getResource("/view/cashier_task_form.fxml"))));
                        stage.show();
